...
- `CR-AGENT-PRO` — Code Review Agent Pro — $5.90 — request payment link on Telegram.
- `AGENT-DEBUG-PRO` — Agent Debugging War Room — $6.90 — request payment link on Telegram.
- `CONTEXT-ENGINEERING-PRO` — Repo Context Engineering Pro — $8.90 — request payment link on Telegram.
- `PROMPT-REGRESSION-PRO` — Prompt Regression Test Suite — $9.90 — request payment link on Telegram.
