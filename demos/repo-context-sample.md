...
Payment and delivery: download the encrypted zip, then pay. If you can use the QR code on the site, use it. If you are outside China, message email `qq466886@126.com` for PayPal, Wise, or another available payment method. After payment, send the product code and receipt/screenshot. The password is sent after confirmation.
